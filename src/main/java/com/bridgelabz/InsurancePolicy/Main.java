...
public class Main {
    public static void main(String[] args) throws ParseException {
        ...
        // Adding policies
        manager.addPolicy(new Policy("P101", "Piyush", sdf.parse("2025-05-20"), "Health", 12000));
        manager.addPolicy(new Policy("P102", "Tannu", sdf.parse("2024-04-15"), "Auto", 15000));
        manager.addPolicy(new Policy("P103", "Prince", sdf.parse("2024-04-25"), "Home", 10000));
        manager.addPolicy(new Policy("P102", "Saksham", sdf.parse("2024-07-10"), "Auto", 18000));
